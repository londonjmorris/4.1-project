...
**************************************************************************************/
//y is not defined
//x is defined in the global scope, so it will still print "I'm a local variable", even inside the function scopeThis().
...
/*************************************************************************************
------------ ANSWER -------------------
x is undefined because the variable is declared after the console log within the same scope. foo logs "function hosting" because the console log actually invokes the function.
**************************************************************************************/
...
(function(){
  ...
  console.log(todayIs);
  console.assert(todayIs == "Mon Jun 12 2017 00:00:00 GMT-0400 (EDT)", "#3 Test failed. Did you set the date correctly?");
})();
...
/**************************************************************************************
------------ ANSWER -------------------
Inside the IFEE, the console logs 4. Outside the scope of the function, the constant add is undefined.
**************************************************************************************/
...
(function(){
  ...
  console.assert(stringDate == "Mon Jun 12 2017", "#6 Test Failed. Did you set stringDate correctly?");
})();
...
//     }
//
//     var accountStat = function accountStat() {
//
